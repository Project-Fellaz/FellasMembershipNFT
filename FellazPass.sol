...
contract FellazPass is ERC721, ERC721Enumerable, Ownable, ERC721Pausable {
    ...
    event EVENT_MINT(uint256 indexed id);
    
    constructor(string memory baseURI, address payable creator,uint256 _count) ERC721("Fellaz Pass NFT", "FPN") {
        setBaseURI(baseURI);
